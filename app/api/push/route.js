...
export async function POST(request) {
  try {
    ...
    // فلترة إضافية حسب نوع المركبة المطلوبة للطلب. لو vehicleType مش
    // موجودة (null) — طلب قديم من قبل إضافة الميزة دي — منعملش أي فلترة
    // إضافية، والسلوك القديم يفضل شغال زي ما هو تمامًا.
    if (vehicleType) {
